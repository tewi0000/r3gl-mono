...
use crate::screen::Identifier;

#[allow(type_alias_bounds)]
pub type BindingManager<S, I: Identifier> = HashMap<I, Bindings<S>, FxBuildHasher>;


pub type Bindings<S> = HashMap<KeyCombination, Action<S>, FxBuildHasher>;
